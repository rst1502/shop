...
public class SecurityConfig {
    ...
    @Value("${store.admin-url:http://localhost:4200}") private String adminUrl;
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        config.setAllowedOrigins(List.of(adminUrl, storefrontUrl, "http://localhost:4200", "http://localhost:4201"));
